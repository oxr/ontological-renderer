...
surface :: Parser (Double, Rgb)
surface = pair double rgb


rgb :: Parser Rgb
rgb = do (r,g,b) <- triple double double double  
         return $ V r g b
...
parseScene :: Parser [Object]
parseScene = list parseObject 

parseLight :: Parser Light
parseLight = do { (x,y,z) <- triple double double double ; return $ Light (V x y z) 0 }
